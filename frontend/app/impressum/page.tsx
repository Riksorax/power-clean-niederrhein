...
export const metadata: Metadata = {
  title: "Impressum – Power Clean Niederrhein",
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto">
          <div className="bg-white p-8 md:p-12 rounded-lg shadow-sm content-section">
            <h1 className="text-center font-bold text-moss-green mb-10 text-4xl">Impressum</h1>

            <h2>Angaben gemäß § 5 TMG</h2>
            <p>
              <strong>Daniel Roth</strong>
              <br />
              <strong>Frank Speulmans</strong>
              <br />
            ...
            <h2>Kontakt</h2>
            <p>
              Telefon: +49 162 1922441
              <br />
              Telefon: +49 1525 6818526
              <br />
              E-Mail:{" "}
