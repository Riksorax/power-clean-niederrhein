...
export const metadata: Metadata = {
  title: "Datenschutz – Power Clean Niederrhein",
        ...
        <div className="max-w-3xl mx-auto">
          <div className="bg-white p-8 md:p-12 rounded-lg shadow-sm content-section">
            ...
            <p>
              ...
              durch das Ausfüllen unseres Kontaktformulars. Andere Daten werden automatisch oder
              nach Ihrer Einwilligung beim Besuch der Website durch unsere IT-Systeme erfasst. Das
            ...
            <p>
              ...
              Bearbeitung Ihrer Anfragen verwendet werden.
            </p>
            <p>
            ...
            <p>
              ...
              <br />
              <br />
              <strong>Roth &amp; Speulmans Power Clean Niederrhein GbR</strong>
              <br />
              Daniel Roth &amp; Frank Speulmans
              <br />
              Thielenstr. 3
              <br />
              47574 Goch
              ...
              <br />
              E-Mail:{" "}
              <a href="mailto:info@powercleanniederrhein.de">info@powercleanniederrhein.de</a>
            </p>

            <h2>3. Hosting</h2>
            <p>
              Diese Website wird bei Hetzner Online GmbH gehostet. Anbieter ist die Hetzner Online
              GmbH, Industriestr. 25, 91710 Gunzenhausen (nachfolgend „Hetzner").
            </p>
            <p>
              Wenn Sie unsere Website besuchen, erfasst Hetzner verschiedene Logfiles inklusive
              Ihrer IP-Adressen. Details entnehmen Sie der Datenschutzerklärung von Hetzner:{" "}
              <a
            ...
            <p>
              ...
              Website. Soweit eine entsprechende Einwilligung abgefragt wurde, erfolgt die
            ...
            <p>
              ...
              von personenbezogenen Daten, die zur Erfüllung eines Vertrages erforderlich ist, dient
              Art. 6 Abs. 1 lit. b DSGVO als Rechtsgrundlage. Soweit eine Verarbeitung zur Wahrung
              eines berechtigten Interesses unseres Unternehmens erforderlich ist, dient Art. 6 Abs.
              1 lit. f DSGVO als Rechtsgrundlage.
            </p>
            ...
            <p>
              ...
              Weitergabe zur Erfüllung eines Vertrages mit Ihnen erforderlich ist, oder wir
            ...
            <p>
              ...
              erfasst werden. Die Daten werden gelöscht, sobald sie für die Erreichung des Zweckes
              ihrer Erhebung nicht mehr erforderlich sind, spätestens nach 7 Tagen.
            </p>
            ...
            <p>
              ...
              Anfrage). Zwingende gesetzliche Bestimmungen – insbesondere Aufbewahrungsfristen (in
              der Regel 6–10 Jahre) – bleiben unberührt.
            </p>
            ...
            <p>
              ...
              Abs. 1 lit. b DSGVO (Vertragserfüllung) bzw. Art. 6 Abs. 1 lit. f DSGVO (berechtigtes
              Interesse). Die Daten werden gelöscht, sobald Ihr Anliegen abschließend bearbeitet
              wurde, sofern keine gesetzlichen Aufbewahrungspflichten entgegenstehen.
            </p>

            <h2>6. Ihre Rechte als betroffene Person</h2>
            <h3>Auskunft, Berichtigung und Löschung (Art. 15–17 DSGVO)</h3>
            <p>
              Sie haben jederzeit das Recht, unentgeltlich Auskunft über Herkunft, Empfänger und
              Zweck Ihrer gespeicherten personenbezogenen Daten zu erhalten. Sie haben außerdem ein
            ...
            <p>
              ...
              Verarbeitung unrechtmäßig ist, Sie aber deren Löschung ablehnen, oder wir die Daten
              nicht mehr benötigen, Sie diese jedoch zur Geltendmachung, Ausübung oder Verteidigung
            ...
            <p>
              ...
              jederzeit gegen die Verarbeitung Ihrer personenbezogenen Daten, die auf Grundlage von
              Art. 6 Abs. 1 lit. f DSGVO erfolgt, Widerspruch einzulegen. Wir verarbeiten die
            ...
            <h3>Widerrufsrecht bei Einwilligungen (Art. 7 Abs. 3 DSGVO)</h3>
            <p>
              Sie haben das Recht, eine erteilte Einwilligung zur Datenverarbeitung jederzeit mit
              Wirkung für die Zukunft zu widerrufen. Die bis zum Widerruf erfolgte Verarbeitung
            ...
            <p>
              ...
              Fragen ist der Landesbeauftragte für den Datenschutz des Bundeslandes
              Nordrhein-Westfalen:
              <br />
              <br />
            ...
            <h2>8. Cookies und Einwilligungsverwaltung (CCM19)</h2>
            <p>
              Diese Website verwendet Cookies. Cookies sind kleine Textdateien, die Ihr Browser auf
              Ihrem Endgerät speichert. Einige Cookies sind technisch notwendig, andere werden nur
              mit Ihrer Einwilligung gesetzt.
            </p>
            <p>
              Zur Verwaltung Ihrer Cookie-Einwilligungen setzen wir das Consent-Management-Tool{" "}
              <strong>CCM19</strong> der Papoo Software &amp; Media GmbH, Auguststr. 4, 53229 Bonn
              ein. CCM19 speichert Ihre Einwilligungsentscheidung in einem Cookie, um Ihre Auswahl
              bei einem erneuten Besuch zu berücksichtigen. Die dabei erhobenen Daten werden
              ausschließlich für die Nachweisführung der Einwilligung verwendet.
            </p>
            <p>
              Rechtsgrundlage: Art. 6 Abs. 1 lit. c DSGVO (rechtliche Verpflichtung zur
              Nachweisbarkeit der Einwilligung) sowie Art. 6 Abs. 1 lit. f DSGVO (berechtigtes
              Interesse). Weitere Informationen:{" "}
              <a
                href="https://www.ccm19.de/datenschutzerklaerung/"
                target="_blank"
                rel="noopener noreferrer"
              >
            ...
            <p>
              ...
              verwendet Cookies, die eine Analyse der Benutzung der Website ermöglichen. Die durch
              das Cookie erzeugten Informationen über Ihre Benutzung dieser Website werden in der
            ...
            <p>
              <strong>Zweck:</strong> Die Nutzung von Google Analytics erfolgt zu dem Zweck, die
              Nutzung unserer Website analysieren und verbessern zu können. Wir erhalten Berichte
              über die Nutzung der Website, z.&nbsp;B. welche Seiten wie häufig aufgerufen werden.
            </p>
            <p>
              <strong>Rechtsgrundlage:</strong> Google Analytics wird nur nach Ihrer ausdrücklichen
              Einwilligung über unser Cookie-Banner (CCM19) gesetzt. Rechtsgrundlage ist Art. 6 Abs.
              1 lit. a DSGVO. Ihre Einwilligung können Sie jederzeit für die Zukunft widerrufen,
              indem Sie die Cookie-Einstellungen über den Link im Footer dieser Website erneut
              aufrufen.
            </p>
            <p>
              <strong>Datenübermittlung in die USA:</strong> Google LLC ist als US-amerikanisches
              Unternehmen am EU-U.S. Data Privacy Framework zertifiziert, das ein angemessenes
              Datenschutzniveau sicherstellt. Darüber hinaus nutzt Google Standardvertragsklauseln
              gemäß Art. 46 Abs. 2 lit. c DSGVO.
            </p>
            <p>
              <strong>Speicherdauer:</strong> Die im Rahmen von Google Analytics gesetzten Cookies
              werden nach 2 Jahren gelöscht. Auf Nutzerebene erhobene Daten werden nach 14 Monaten
              automatisch gelöscht.
            </p>
            <p>
              <strong>Widerspruch / Opt-out:</strong> Sie können die Erfassung Ihrer Daten durch
              Google Analytics verhindern, indem Sie das Browser-Plugin unter folgendem Link
            ...
            <p>
              Weitere Informationen zum Umgang mit Nutzerdaten bei Google Analytics finden Sie in
